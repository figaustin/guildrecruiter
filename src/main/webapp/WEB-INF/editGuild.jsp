...
<p class="flex justify-center text-3xl mt-24 font-semibold">Edit ${guild.name}'s post</p>
<div class="flex justify-center items-center mt-6">
    <form:form action="/guild/edit/${guild.id}" method="post" modelAttribute="guild">
        <div class="flex flex-col">
            ...
            <input type="submit" value="Edit Post" class="border border-black rounded mt-4 bg-zinc-400">
        </div>
    </form:form>
